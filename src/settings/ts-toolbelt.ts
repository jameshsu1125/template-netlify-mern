...
// OBJECT
{
  ...
  // 任何一個: name 或 email 變成其中一個變 optional
  type either = Object.Either<User, 'name' | 'email'>;

  // 移除某type但不包含其optional type
  type filter = Object.Filter<User, number | string>;
  ...
  // 跟Partial一樣
  type optional = Object.Optional<User, 'email'>;
  ...
  // Record ? 是optional ! 是required
  type record = Object.Record<'name' | 'surname', number, ['?', 'W']>;
